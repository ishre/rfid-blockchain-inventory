...
<header>
	<div class="header">
		<div class="logo">
			<a href="index.php">Blockchain Inventory Manager</a>
		</div>
	</div>
	<?php
	if (isset($_GET['error'])) {
	...
	<div class="topnav" id="myTopnav">
		<a href="index.php">Containers</a>
		<a href="ManageUsers.php">Manage Containers</a>
		<a href="UsersLog.php">Container Log</a>
